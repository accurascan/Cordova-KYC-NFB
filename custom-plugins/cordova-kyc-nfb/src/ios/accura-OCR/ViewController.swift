...
//            ScanConfigs.accuraConfigs["rg_setBackSide"] = true
        ...
        if isBarCode {
            ...
            accuraCameraWrapper = AccuraCameraWrapper.init(delegate: self, andImageView: _imageView, andLabelMsg: self.lblOCRMsg, andurl: NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true)[0] as String, andMRZDocType: Int32(self.MRZDocType))
...
//                break
    ...
    func onUpdateLayout(_ frameSize: CGSize) {
